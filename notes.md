...
### 02.10.23
- table: excel to latex
- adobe illustrator can layer images and export it as pdflatex
- Section: Results
  - First show what works, combine resulting images into one figure
  - Separate plots if possible and combine them
  - Afterwards show what does not work
- Section: Conclusion
  - Move your suggestions here
- Move method into 4th section (combine it w/ image acquisition)
- Extend background w/ ray tracing and physics based rendering, volumetric rendering eq.
- Change bsdf models that you use with equations