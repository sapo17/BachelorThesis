...
COLUMN_LABEL_BETA_1: str = "Beta 1"
COLUMN_LABEL_BETA_2: str = "Beta 2"
...
PARAMETER_ERROR_PLOT_STRING: str = "Convergence Plot"
OFF_STRING: str = "off"
...
MAX_BETA_VALUE: float = 0.999
MIN_BETA_VALUE: float = 0.0
